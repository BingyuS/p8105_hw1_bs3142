...
``` r
q2_xy_sp1 <- ggplot(q2_df, aes(x = x, y = y, color = q2_vec_logical)) + geom_point()

q2_xy_sp1
```

![](p8105_hw1_bs3142_files/figure-markdown_github/unnamed-chunk-3-1.png) Blue dots represent x + y &gt; 0, and red dots represent x + y &lt; 0.

``` r
q2_xy_sp2 <- ggplot(q2_df, aes(x =x, y = y, color = q2_vec_numeric)) + geom_point()

q2_xy_sp2
```

![](p8105_hw1_bs3142_files/figure-markdown_github/unnamed-chunk-4-1.png)

``` r
q2_xy_sp3 <- ggplot(q2_df, aes(x =x, y = y, color = q2_vec_factor)) + geom_point()

q2_xy_sp3
```

![](p8105_hw1_bs3142_files/figure-markdown_github/unnamed-chunk-5-1.png)
